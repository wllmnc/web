...
%
% Original author:
% Claud D. Park (posquit0.bj@gmail.com) with modifications by William Nunez
...
\mobile{(+52) 331-600-1512}

\email{wnunez.mx@gmail.com}
\homepage{www.wnunez.com}
\github{wllmnc}
\linkedin{wllmnc}
\hackerrank{wnunez}
%\skype{skypeid}
...
\quote{``Easy isn't always simple"} % A quote or statement

\makecvfooter{\today}{Wllm Nunez~~~·~~~Resume}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
